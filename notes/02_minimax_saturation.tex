...
\textbf{Update (2026-05-24).}  Conjecture~1 (non-realisable minimax,
§3 below) is \emph{withdrawn} in
\texttt{notes/03\_non\_realisable\_resolution.tex}.  The non-realisable
regime turns out to be vacuous: the realisable theorem
(Theorem~\ref{thm:upper-corrected} below) applies uniformly to any
learner once $\bP_{\Scal_\Acal}\by$ is replaced by the
population-risk minimiser $f^\star_{\Hcal_d}$ and the spectral $R^2$
of $\Scal_\Acal$ by that of $\Hcal_d$.  The $\sigma_\Pi$ factor
conjectured here was an artefact of the Pesenson-ridge construction,
not a genuine minimax rate.  The Bauer--Pereverzev 2005 pointer in
§3 is a wrong-domain reference: their theory is for noisy continuous
inverse problems, ours is finite-population empirical-risk.  Apart
from this update, the contents of this note (Theorem~\ref{thm:upper-corrected},
Theorem~\ref{thm:minimax-lower}, Erratum to notes/01 Theorem~2) stand.}}
\end{center}
